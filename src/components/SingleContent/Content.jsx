...
const Content = ({
  ...
  return (
    <div className='relative bg-gradient-to-r from-[#141e30] to-[#764AF1]  text-white hover:bg-white rounded-lg  m-4 p-1'>
      <span className='absolute -mt-2 -ml-2 bg-gradient-to-r from-[#764AF1] to-[#141e30] text-white rounded-lg p-1'>{vote_average}</span>
